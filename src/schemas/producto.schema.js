...
const productoSchema = z.object({
    ...
    costo: z.number().min(0, 'El costo no puede ser negativo').nullable().optional(),
    stock: z.number({ invalid_type_error: 'El stock debe ser un número' }).int('El stock debe ser un entero').min(0, 'El stock no puede ser negativo').nullable().optional().default(0),
    stock_min: z.number().int().min(0).nullable().optional().default(0),
